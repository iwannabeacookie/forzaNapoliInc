        ...
        <div class="skills__container container grid">
            ...
            <div class="skills__content skills__close">
                ...
                <div class="skills__list grid">
                    ...
                    <div class="skills__data">
                        <div class="skills__titles">
                            <h3 class="skills__name">Lenguajes y paradigmas de la programación</h3>
                            <span class="skills__number">60%</span>
                        </div>
                        <div class="skills__bar">
            ...
            <div class="qualification__sections">
                ...
                <div class="qualification__content qualification__active" data-content id="education">
                    ...
                    <div class="qualification__data">
                        ...
                        <div>
                            <h3 class="qualification__title">Associate's degree, Computer Engineering</h3>
                    ...
                    <div class="qualification__data">
                        <div>
                            <h3 class="qualification__title">Ingeniería Civil, Informática</h3>
                    ...
                    <div class="qualification__data">
                        ...
                        <div>
                            <h3 class="qualification__title">EF International Language Campuses</h3>
                ...
                <div class="qualification__content" data-content id="work">
                    ...
                    <div class="qualification__data">
                        <div>
                            <h3 class="qualification__title">Sistemas gestión de inventario</h3>
                            <span class="qualification__subtitle">Desarrollo de software Fullstack a medida - PHP</span>
                            <div class="qualification__calendar">
                                <i class="uil uil-calendar-alt"></i>
                                2018 - 2019
                    ...
                    <div class="qualification__data">
                        <div>
                            <h3 class="qualification__title">Sistemas de Gestión de documentos</h3>
                            <span class="qualification__subtitle">Desarrollo de software Fullstack a medida - PHP</span>
                            <div class="qualification__calendar">
                                <i class="uil uil-calendar-alt"></i>
                                2023 - 2024
                    ...
                    <div class="qualification__data">
                        ...
                        <div>
                            <h3 class="qualification__title">Sistemas de gestión de reuniones</h3>
                            <span class="qualification__subtitle">Desarrollo de software Fullstack a medida - PHP</span>
                            <div class="qualification__calendar">
                                <i class="uil uil-calendar-alt"></i>
                                2023 - 2024
                    ...
                    <div class="qualification__data">
                        <div>
                            <h3 class="qualification__title">Sistema de gestión para consultora de inmobiliarias</h3>
                            <span class="qualification__subtitle">Desarrollo de software Fullstack a medida - PHP</span>
                            <div class="qualification__calendar">
                                <i class="uil uil-calendar-alt"></i>
                                2023 - 2024
                    ...
                    <div class="qualification__data">
                        ...
                        <div>
                            <h3 class="qualification__title">Ambassador en Education first</h3>
                ...
                <div class="portfolio__content grid swiper-slide">
                    ...
                    <div class="portofolio__data">
                        ...
                        <p class="portfolio__description">El presente trabajo tiene por objetivo desarrollar la
                            ...
                            utilizado para buscar dar una respuesta a la problemática planteada, además del material
                            utilizado. Posteriormente se tiene la entrega de resultados en los cuales se consideran
